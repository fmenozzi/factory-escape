...
const ABILITY_ROOMS := {
    ...
    DemoAbility.Ability.DOUBLE_JUMP: [
        ...
        [preload('res://rooms/demo/rooms/double_jump/ContainmentArena.tscn'), Vector2(8320, 720)],
        [preload('res://rooms/demo/rooms/double_jump/DoubleJumpEnd.tscn'), Vector2(8960, 720)],
    ],
    ...
    DemoAbility.Ability.GRAPPLE: [
        ...
        [preload('res://rooms/demo/rooms/grapple/UShaft.tscn'), Vector2(5440, 900)],
        [preload('res://rooms/demo/rooms/grapple/UShaftConnector.tscn'), Vector2(5760, 900)],
        [preload('res://rooms/demo/rooms/grapple/GrappleLamp.tscn'), Vector2(6080, 900)],
        [preload('res://rooms/demo/rooms/grapple/NShaft.tscn'), Vector2(6400, 720)],
        [preload('res://rooms/demo/rooms/grapple/NShaftConnector.tscn'), Vector2(6720, 900)],
        [preload('res://rooms/demo/rooms/grapple/HazardTunnel.tscn'), Vector2(7360, 900)],
        [preload('res://rooms/demo/rooms/grapple/ArenaAntechamber.tscn'), Vector2(8000, 900)],
        [preload('res://rooms/demo/rooms/grapple/GrappleArena.tscn'), Vector2(8000, 1080)],
        [preload('res://rooms/demo/rooms/grapple/GrappleEnd.tscn'), Vector2(8320, 1080)],
    ],
    ...
    DemoAbility.Ability.WALL_JUMP: [
        ...
        [preload('res://rooms/demo/rooms/wall_jump/CargoProcessing.tscn'), Vector2(6720, 1260)],
        [preload('res://rooms/demo/rooms/wall_jump/ProcessingConnector.tscn'), Vector2(7360, 1260)],
        [preload('res://rooms/demo/rooms/wall_jump/SiloConnector.tscn'), Vector2(7680, 1260)],
        [preload('res://rooms/demo/rooms/wall_jump/PrimarySiloStorage.tscn'), Vector2(8000, 720)],
        [preload('res://rooms/demo/rooms/wall_jump/SiloArena.tscn'), Vector2(8320, 720)],
        [preload('res://rooms/demo/rooms/wall_jump/WallJumpEnd.tscn'), Vector2(8960, 720)],
    ],
}
