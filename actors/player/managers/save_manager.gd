...
var has_completed_central_hub_fall_sequence: bool = false
var has_completed_sector_five_fall_sequence: bool = false
...
func get_save_data() -> Array:
    return ['player', {
        ...
        'has_completed_central_hub_fall_sequence': has_completed_central_hub_fall_sequence,
        'has_completed_sector_five_fall_sequence': has_completed_sector_five_fall_sequence,
    }]
...
func load_version_0_1_0(all_save_data: Dictionary) -> void:
    ...
    assert('has_completed_central_hub_fall_sequence' in player_save_data)
    assert('has_completed_sector_five_fall_sequence' in player_save_data)
    ...
    has_completed_central_hub_fall_sequence = player_save_data['has_completed_central_hub_fall_sequence']
    has_completed_sector_five_fall_sequence = player_save_data['has_completed_sector_five_fall_sequence']
