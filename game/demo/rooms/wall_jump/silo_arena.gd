...
onready var _save_manager: SiloArenaSaveManager = $SaveManager
...
func _process(delta: float) -> void:
    match _save_manager.current_room_state:
        RoomState.PRE_FIGHT:
            ...
            _spawn_enemy_at(leaping_failure_right, Vector2(576, 160))
        ...
        RoomState.WAVE_1:
            if _current_wave_enemy_count == 0:
                ...
                _spawn_enemy_at(sentry_drone, Vector2(576, 128))
                _spawn_enemy_at(leaping_failure, Vector2(384, 160))
        ...
        RoomState.WAVE_2:
            if _current_wave_enemy_count == 0:
                ...
                _spawn_enemy_at(sticky_drone_right, Vector2(624, 112))
